  ...
  return (
    ...
    <section>
        <ul className='list-none flex mt-1 mx-20 list-elements'>
            <li className='mx-12 mt-6 font-sans font-normal text-lg'>Home</li>
            <li className='mx-12 mt-6 font-sans font-normal text-lg'>Why Us</li>
            <li className='mx-12 mt-6 font-sans font-medium text-lg' style={{color:'#215D4F'}}>Courses</li>
            <li className='mx-12 mt-6 font-sans font-normal text-lg'>Mentors</li>
            <li className='mx-12 mt-6 font-sans font-normal text-lg'>Contact us</li>
        </ul>
    </section>
    <section className='flex mt-4    ml-80'>
